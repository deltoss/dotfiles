...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("uwsm app -- xremap --watch=config,device " .. config_home .. "/xremap/config.yml")
...
hl.window_rule({ match = { class = "^(md.Obsidian)$" }, workspace = "5" })
...
hl.bind("SUPER + Z", apps.run_or_raise("md.Obsidian", "uwsm app -- obsidian"))
